namespace Proyecto_Asados_La_Flaca_Versión_1._1_Completo.Catalogs
{
    partial class FrmMainMenu
    {
        ...
        private void InitializeComponent()
        {
            ...
            // Category
            // 
            Category.BackColor = Color.Goldenrod;
            Category.Dock = DockStyle.Top;
            Category.FlatStyle = FlatStyle.Flat;
            Category.Font = new Font("Georgia", 9F, FontStyle.Bold, GraphicsUnit.Point, 0);
            Category.ForeColor = Color.White;
            Category.Location = new Point(0, 588);
            Category.Margin = new Padding(6);
            Category.Name = "Category";
            Category.Size = new Size(292, 75);
            Category.TabIndex = 6;
